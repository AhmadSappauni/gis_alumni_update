<aside class="sidebar glass-panel">
    ...
    <nav class="nav-menu">
        ...
        <a href="{{ route('admin.alumni.index') }}" class="nav-item {{ request()->routeIs('admin.alumni.index') || request()->routeIs('admin.alumni.edit') ? 'active' : '' }}">
            <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar-footer">
        <a href="{{ route('peta') }}" class="btn-kembali">
