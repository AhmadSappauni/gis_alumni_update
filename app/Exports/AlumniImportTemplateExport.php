...
class AlumniImportTemplateExport implements FromArray, ShouldAutoSize, WithStyles
{
    ...
    public static function columns(): array
    {
        return [
            ...
            [
                'header' => 'kampus_studi_lanjut',
                'stored_to' => 'studi_lanjut.kampus',
                'required' => false,
                'description' => 'Nama kampus atau perguruan tinggi studi lanjut.',
                'example' => 'Universitas Lambung Mangkurat',
            ],
            [
                'header' => 'program_studi_lanjut',
                'stored_to' => 'studi_lanjut.program_studi',
                'required' => false,
                'description' => 'Nama program studi pada studi lanjut.',
                'example' => 'Magister Pendidikan Komputer',
            ],
            [
                'header' => 'alamat_kampus',
                'stored_to' => 'studi_lanjut.alamat_kampus',
                'required' => false,
                'description' => 'Alamat kampus studi lanjut.',
                'example' => 'Jl. Brigjen H. Hasan Basri',
            ],
            [
                'header' => 'kota_kampus',
                'stored_to' => 'studi_lanjut.kota_kampus',
                'required' => false,
                'description' => 'Kota atau kabupaten lokasi kampus studi lanjut.',
                'example' => 'Banjarmasin',
            ],
            [
                'header' => 'provinsi_kampus',
                'stored_to' => 'studi_lanjut.provinsi_kampus',
                'required' => false,
                'description' => 'Provinsi lokasi kampus studi lanjut.',
                'example' => 'Kalimantan Selatan',
            ],
            [
                'header' => 'latitude_kampus',
                'stored_to' => 'studi_lanjut.latitude',
                'required' => false,
                'description' => 'Latitude kampus studi lanjut. Jika valid, dipakai langsung tanpa geocoding.',
                'example' => '-3.2950',
            ],
            [
                'header' => 'longitude_kampus',
                'stored_to' => 'studi_lanjut.longitude',
                'required' => false,
                'description' => 'Longitude kampus studi lanjut. Jika valid, dipakai langsung tanpa geocoding.',
                'example' => '114.5820',
            ],
            [
                'header' => 'jenjang',
