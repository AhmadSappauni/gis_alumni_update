    ...
    <div id="card-view-wrapper">
        <div id="card-view" class="cards-grid">
            ...
            ?>
                <div class="data-card glass-panel"
                    ...
                    <?php if($jumlahPekerjaanAktif > 1 || $jumlahStudiLanjut > 0): ?>
                        <div style="position: absolute; top: 15px; right: 15px; display: flex; flex-direction: column; gap: 6px; align-items: flex-end; z-index: 10; max-width: 55%;">
                            ...
                            <?php if($jumlahStudiLanjut > 0): ?>
                                <?php $__currentLoopData = $badgeStudi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teksBadge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div title="Memiliki studi lanjut"
                                        ...
                                        <?php echo e($teksBadge); ?>

                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <?php if($sisaStudiLanjut > 0): ?>
                                    <div title="<?php echo e($sisaStudiLanjut); ?> studi lanjut lainnya"
                    ...
                    <div class="card-header">
                        ...
                        <span>
                            <?php echo e($alumni->akademik?->tahun_lulus 
                    ...
                    <div class="completion-wrap">
                        <button type="button" style="margin-top: -10px; margin-bottom: 10px;" class="completion-badge <?php echo e($kelengkapan['is_complete'] ? 'is-complete' : 'is-incomplete'); ?>">
                            <span><?php echo $kelengkapan['is_complete'] ? '&#10003;' : '&#9888;'; ?></span>
                            <?php echo e($kelengkapan['is_complete'] ? 'Data Lengkap' : 'Belum Lengkap'); ?>

                        </button>
                        <div class="completion-popover">
                            <div class="completion-title">Checklist Kelengkapan</div>
                            <div class="completion-row <?php echo e($kelengkapan['data_diri'] ? 'is-ok' : 'is-missing'); ?>">
                                <span><?php echo $kelengkapan['data_diri'] ? '&#10003;' : '&#10007;'; ?></span>
                                Data Diri
                            </div>
                            <div class="completion-row <?php echo e($kelengkapan['pekerjaan_required'] ? ($kelengkapan['pekerjaan'] ? 'is-ok' : 'is-missing') : 'is-muted'); ?>">
                                <span><?php echo !$kelengkapan['pekerjaan_required'] ? '-' : ($kelengkapan['pekerjaan'] ? '&#10003;' : '&#10007;'); ?></span>
                                Pekerjaan <?php echo e(!$kelengkapan['pekerjaan_required'] ? 'tidak wajib' : ''); ?>

                            </div>
                            <div class="completion-row <?php echo e($kelengkapan['studi_lanjut_required'] ? ($kelengkapan['studi_lanjut'] ? 'is-ok' : 'is-missing') : 'is-muted'); ?>">
                                <span><?php echo !$kelengkapan['studi_lanjut_required'] ? '-' : ($kelengkapan['studi_lanjut'] ? '&#10003;' : '&#10007;'); ?></span>
                                Studi Lanjut <?php echo e(!$kelengkapan['studi_lanjut_required'] ? 'tidak wajib' : ''); ?>

                            </div>
                            <?php if(!$kelengkapan['is_complete']): ?>
                                <div class="completion-missing">
                                    Belum lengkap: <?php echo e(implode(', ', $kelengkapan['missing_fields'])); ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php if($pekerjaanAktif): ?>
                            <div class="info-row">
                                ...
                                <b><?php echo e($pekerjaanAktif->perusahaan?->nama_perusahaan); ?></b>
                            </div>
                            <div class="info-row">
                        ...
                        <?php else: ?>
                            <div style="padding: 10px; background:rgba(255,255,255,0.4); border-radius:10px; border:1px dashed #004a87;">
                                <div class="info-row" style="margin-bottom: 0; justify-content: center;">
                                    ...
                                    <span style="color:#004a87; font-weight:700; font-size:11px;">Domisili: <?php echo e($alumni->alamat?->kota ?? 'Pusat Banjarmasin'); ?></span>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="action-buttons">
                            <button class="btn-icon view" onclick="document.getElementById('modal-profil-<?php echo e($alumni->id); ?>').style.display='flex'" title="Lihat Profil Lengkap">
                            ...
                            <a href="<?php echo e(route('admin.alumni.edit', $alumni->id)); ?>" class="btn-icon edit" title="Edit Data">
                            ...
                            <button type="button" class="btn-icon delete" 
                                    onclick="confirmDelete('<?php echo e($alumni->id); ?>','<?php echo e($alumni->nim); ?>', '<?php echo e($alumni->nama_lengkap); ?>')" 
                                    title="Hapus Data">
                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="pagination-footer d-flex justify-content-between align-items-center" style="padding: 10px 25px; margin-bottom: 30px; border-top: 1px solid rgba(0,0,0,0.05); background: rgba(255,255,255,0.3);">
            ...
            <div class="pagination-meta">
                <span class="pagination-showing">Showing <?php echo e($from); ?> to <?php echo e($to); ?> of <?php echo e($total); ?> rows</span>
                <div class="per-page-select-wrap">
                    <select class="per-page-select" aria-label="Rows per page">
                        <?php $__currentLoopData = $perPageOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($opt); ?>" <?php echo e($perPageActive === $opt ? 'selected' : ''); ?>><?php echo e($opt); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="pagination-links pagination-links--compact">
                <?php echo e($dataAlumni->onEachSide(1)->links('vendor.pagination.admin-compact')); ?>

            </div>
        </div>
        <div id="card-empty" class="no-results" style="display: <?php echo e(($isQueryActive && !$hasResults) ? 'block' : 'none'); ?>;">
        ...
        <div id="list-view" class="glass-panel" style="display: none; padding: 0; overflow: visible; margin-top: 10px;">
            ...
            <div id="bulk-action-bar" data-total="<?php echo e($totalAlumni ?? ''); ?>" style="display:flex; align-items:center; gap:12px;">
        ...
        <div class="table-scroll" style="max-height: 480px; overflow-y: auto;">
            <table class="alumni-table" style="width: 100%; border-collapse: collapse;">
                    ...
                    ?>
                        <tr
                            ...
                            <td>
                                <div style="font-size: 12px; line-height: 1.4; color: #475569;">
                                    <?php if($pekerjaanAktif): ?>
                                        <div style="font-weight: 700;"><?php echo e($pekerjaanAktif->perusahaan?->nama_perusahaan); ?></div>
                                        <div style="font-size: 11px;"><?php echo e($alumni->alamat?->kota); ?></div>
                                    <?php else: ?>
                                        <div style="color: #004a87; font-weight: 600;"> <?php echo e($alumni->alamat?->kota ?? 'Banjarmasin'); ?></div>
                            ...
                            <td>
                                <?php if($pekerjaanAktif): ?>
                                    <?php echo e($pekerjaanAktif->jabatan); ?>
                            ...
                            <td>
                                <div class="completion-wrap completion-wrap--table">
                                    <button type="button" class="completion-badge <?php echo e($kelengkapan['is_complete'] ? 'is-complete' : 'is-incomplete'); ?>">
                                        <span><?php echo $kelengkapan['is_complete'] ? '&#10003;' : '&#9888;'; ?></span>
                                        <?php echo e($kelengkapan['is_complete'] ? 'Lengkap' : 'Belum Lengkap'); ?>
                            ...
                            <td>
                                <div style="display: flex; justify-content: center; gap: 8px;">
                                    <button class="action-btn-small view" onclick="document.getElementById('modal-profil-<?php echo e($alumni->id); ?>').style.display='flex'" title="Lihat Profil Lengkap">
                                    ...
                                    <a href="<?php echo e(route('admin.alumni.edit', $alumni->id)); ?>" class="action-btn-small edit"><svg width="14" height="14"
                ...
                <tbody id="list-empty" style="display: <?php echo e(($isQueryActive && !$hasResults) ? 'table-row-group' : 'none'); ?>;">
...
<?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_5\resources\views/admin/komponen/content.blade.php ENDPATH**/ ?>