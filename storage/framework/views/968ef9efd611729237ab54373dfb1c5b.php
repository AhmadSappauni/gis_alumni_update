...
<?php $__env->startSection('content'); ?>
    ...
    <div style="max-width: 1000px; margin: 0 auto;">
        ...
        <div id="tab-studi" class="tab-pane glass-panel" style="padding: 30px;">
            ...
            <?php if($alumni->studiLanjut->isEmpty()): ?>
                <div style="text-align: center; padding: 40px; background: rgba(0,74,135,0.03); border-radius: 16px; border: 2px dashed rgba(0,74,135,0.2);">
            ...
            <?php else: ?>
                <div style="display: grid; gap: 12px;">
                    <?php $__currentLoopData = $alumni->studiLanjut->sortByDesc('tahun_masuk'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div style="background: #ffffff; border: 1px solid #f1f5f9; border-radius: 16px; padding: 16px; box-shadow: 0 2px 6px rgba(0,0,0,0.04); display: flex; justify-content: space-between; gap: 15px;">
                            <div style="flex: 1;">
                                <div style="display: flex; justify-content: space-between; gap: 10px; align-items: flex-start;">
                                    <div>
                                        <div style="font-weight: 800; color: #1e293b; font-size: 15px;"><?php echo e($s->kampus); ?></div>
                                        <div style="color: #94a3b8; margin-top: 4px; font-size: 13px; display: flex; align-items: center; gap: 6px;">
                                            <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                            <?php echo e(collect([$s->kota_kampus, $s->provinsi_kampus])->filter()->implode(', ') ?: '-'); ?>

                                        </div>
                                        <div style="color: #475569; font-weight: 700; margin-top: 4px;">
                                            <?php echo e($s->jenjang); ?>

                                            <?php if($s->program_studi): ?>
                                                - <?php echo e($s->program_studi); ?>
                                    ...
                                    <span style="background: <?php echo e($badge[0]); ?>; color: <?php echo e($badge[1]); ?>; padding: 6px 12px; border-radius: 10px; font-size: 12px; font-weight: 800; border: 1px solid <?php echo e($badge[2]); ?>; white-space: nowrap;">
                                        <?php echo e($s->status); ?>
                            ...
                            <div style="display: flex; gap: 8px; align-items: flex-start;">
                                <button type="button" onclick='editStudiLanjut(<?php echo json_encode($dataEditStudi, 15, 512) ?>)' title="Edit studi lanjut" style="background: #e0f2fe; color: #0284c7; border: none; padding: 10px; border-radius: 12px; cursor: pointer; transition: 0.2s;">
                                    <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                </button>

                                <form action="<?php echo e(route('admin.studi-lanjut.destroy', ['alumni' => $alumni->id, 'studiLanjut' => $s->id])); ?>" method="POST" class="form-hapus-studi">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
    ...
    <?php echo $__env->make('admin.komponen.studi-lanjut', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    window.editConfig = {
        ...
        studiLanjutBaseUrl: <?php echo json_encode(url('/admin/alumni/' . $alumni->id . '/studi-lanjut'), 15, 512) ?>,
        initialTab: <?php echo json_encode(session('active_tab') ?? request('tab'), 15, 512) ?>
    };
    </script>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_5\resources\views/admin/edit.blade.php ENDPATH**/ ?>