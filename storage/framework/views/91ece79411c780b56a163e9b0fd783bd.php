        ...
        <section class="template-modal-panel" role="dialog" aria-modal="true" aria-labelledby="template-modal-title">
            <div class="template-modal-header">
                ...
                <div class="template-modal-actions">
                    <a href="<?php echo e(route('admin.alumni.import.template')); ?>" class="btn-template btn-template-primary">
            ...
            <div class="template-table-wrap">
                <table class="template-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $templateColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><code><?php echo e($column['header']); ?></code></td>
                                <td>
                                ...
                                <td><?php echo e($column['description']); ?></td>
                                <td><?php echo e($column['example'] !== '' ? $column['example'] : '-'); ?></td>
                            </tr>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_5\resources\views/admin/import/import-excel.blade.php ENDPATH**/ ?>