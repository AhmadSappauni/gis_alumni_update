<div id="modal-pekerjaan" class="profil-modal-overlay">
    <div class="profil-modal-card" style="max-width: 650px; max-height: 90vh; overflow-y: auto;">
        ...
        <form action="<?php echo e(route('admin.pekerjaan.store', $alumni->nim)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                ...
                <div>
                    ...
                    <input type="text" name="kota" class="custom-input-admin" placeholder="Jakarta Selatan"
                        required>
                </div>
                <div>
                    <label class="label-admin">Bidang</label>
                    <select name="bidang" class="custom-input-admin" required>
    ...
    <div class="profil-modal-card" style="max-width: 650px; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="form-edit-pekerjaan" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                ...
                <div>
                    <label class="label-admin">Bidang</label>
                    <select name="bidang" id="edit_bidang" class="custom-input-admin" required>
                        <option value="IT & Software">IT & Software</option>
                        <option value="Pendidikan / Guru">Pendidikan / Guru</option>
                        <option value="Pemerintahan">Pemerintahan</option>
                        <option value="Wiraswasta">Wiraswasta</option>
                ...
                <div>
                    <label class="label-admin">Estimasi Gaji (Opsional)</label>
                    <input type="text" name="gaji" id="edit_gaji" class="custom-input-admin">
                </div>
                <div>
                    <label class="label-admin">Link LinkedIn (Opsional)</label>
...
<?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_2\resources\views/admin/komponen/riwayat-pekerjaan.blade.php ENDPATH**/ ?>