...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        window.__STATISTIK_EXPORT_PDF__ = <?php echo json_encode(route('admin.statistik.export.pdf'), 15, 512) ?>;
        window.__STATISTIK_EXPORT_EXCEL__ = <?php echo json_encode(route('admin.statistik.export.excel'), 15, 512) ?>;
    </script>
    <script src="<?php echo e(asset('js/admin/statistik.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_5\resources\views/admin/statistik/index.blade.php ENDPATH**/ ?>