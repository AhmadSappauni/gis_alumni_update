...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/utama/statistik.css')); ?>">
</head>
<body>
    <header class="stat-topbar">
        <div class="stat-topbar-inner stat-container">
            <a class="stat-back" href="<?php echo e(route('map.index')); ?>" aria-label="Kembali ke Peta">
    ...
    <main class="stat-wrap">
        <div class="stat-container">
            <section class="stat-panel">
                ...
                <div id="stat-filter-panel" class="stat-filter-panel" <?php echo e($hasInitialFilters ? '' : 'hidden'); ?>>
    ...
    <script>
        window.__STATISTIK_ENDPOINT__ = <?php echo json_encode(route('statistik.data'), 15, 512) ?>;
    </script>
    <script src="<?php echo e(asset('js/utama/statistik.js')); ?>"></script>
</body>
</html>
<?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_5\resources\views/statistik/index.blade.php ENDPATH**/ ?>