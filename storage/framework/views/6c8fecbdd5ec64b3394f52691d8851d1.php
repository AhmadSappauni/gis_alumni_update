    ...
    <button id="toggle-layer-panel" class="layer-toggle-btn" type="button" title="Tampilkan pengaturan layer">
        ...
        <div id="layer-control-menu" class="layer-control-menu hidden">
            ...
            <div class="layer-control-section">
                ...
                <div class="layer-control-item polygon-wilayah-row">
                    <button
                        id="toggle-polygon-wilayah-list"
                        class="polygon-wilayah-toggle-btn polygon-wilayah-toggle-btn--inline"
                        type="button"
                    >
                    ...
                    <div class="polygon-master-toggle">
                        <span class="polygon-master-label">Polygon Wilayah</span>
...
<?php /**PATH D:\Aplikasi_Skripsi\gis_alumni_5\resources\views/utama/cluster.blade.php ENDPATH**/ ?>